...
### Team_6_Library_Terminal.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [Team_6_Library_Terminal.Sample.csproj](../Team_6_Library_Terminal.Sample/Team_6_Library_Terminal.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### Team_6_Library_Terminal.Tests
